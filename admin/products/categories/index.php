...
?>
    ...
    <head>
        ...
        <title>SOUAIBOU DISTRIBUTION | Catégories des produits</title>
    ...
    <body class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 font-sans overflow-hidden">
                ...
                <div class="flex-1 overflow-hidden">
                    <div class="h-full pt-4 pb-4">
                        ...
                        <div class="bg-white/70  backdrop-blur-sm rounded-lg shadow-sm border border-emerald-50 h-full overflow-auto">
                            <div class="p-6">
                                <?php include('./../../includes/gestion_categories.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal pour visualiser une catégorie -->
        <?php include('./../../includes/show_categorie_modal.php'); ?>

        <!-- Modal pour éditer une catégorie -->
        <?php include('./../../includes/edit_categorie_modal.php'); ?>
